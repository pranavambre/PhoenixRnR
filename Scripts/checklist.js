...
survey
    ...
    .add(function (result) {
        ...
        if (finalscore <= 90) {
            document.getElementById("surveyResult").style.backgroundColor = "#fff";
            ...
            document
                .querySelector('#surveyResult')
                .innerHTML = "Your total score is " + JSON.stringify(finalscore) + "%." + "  You are not fully ready. Please go to preparation steps <a href='~/Views/Home/Prepare.cshtml'>Click here!</a>";
        }
        else {
            document.getElementById("surveyResult").style.backgroundColor = "#fff";
            //document.getElementById("surveyResult").style.border = "1px solid rgba(0, 0, 0, 0.4)";
